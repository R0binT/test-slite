...
lp.parseClass = function (isStatement) {
  var node = this.startNode();
  this.next();
  if (this.tok.type === _index.tokTypes.name) node.id = this.parseIdent();else if (isStatement === true) node.id = this.dummyIdent();else node.id = null;
...
lp.parseFunction = function (node, isStatement, isAsync) {
  ...
  if (this.tok.type === _index.tokTypes.name) node.id = this.parseIdent();else if (isStatement === true) node.id = this.dummyIdent();
