...
lp$1.parseClass = function (isStatement) {
  ...
  var node = this.startNode();
  this.next();
  if (this.tok.type === _acorn.tokTypes.name) node.id = this.parseIdent();else if (isStatement === true) node.id = this.dummyIdent();else node.id = null;
...
lp$1.parseFunction = function (node, isStatement, isAsync) {
  ...
  if (this.tok.type === _acorn.tokTypes.name) node.id = this.parseIdent();else if (isStatement === true) node.id = this.dummyIdent();
...
//# sourceMappingURL=acorn_loose.es.js.map